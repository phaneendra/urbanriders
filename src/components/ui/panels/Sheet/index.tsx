...
import { sheetContentStyles, sheetOverlayStyles } from "./sheet-styles";
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ...
    // className={cn(
    //   "bg-overlay data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 backdrop-blur-sm",
    //   className
    // )}
    {...props}
    ref={ref}
