...
export const linkStyles = cva(
  ...
  ],
  {
    variants: {
      size: {
        xs: "gap-1 text-xs py-1 px-2 [&_svg]:w-4 [&_svg]:h-4",
        sm: "gap-2 text-sm py-2 px-3 [&_svg]:w-5 [&_svg]:h-5",
        base: "gap-3 text-base py-3 px-4 [&_svg]:w-6 [&_svg]:h-6",
        lg: "gap-3 text-lg py-4 px-5 [&_svg]:w-7 [&_svg]:h-6",
      },
      weight: {
        light: "font-light",
        regular: "font-normal",
