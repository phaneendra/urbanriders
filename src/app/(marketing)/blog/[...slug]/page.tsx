...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <article className="container relative max-w-3xl py-6 lg:py-10">
      ...
      <div>
        {post.date && (
          <time dateTime={post.date} className="text-fgsubtle block text-sm">
              ...
              author ? (
                ...
                >
                  ...
                  <div className="flex-1 text-left leading-tight">
                    ...
                    <p className="text-fgsubtle text-[12px]">
                      @{author.twitter}
                    </p>
                  </div>
                </Link>
      ...
      {post.image && (
        <Image
          ...
          width={720}
          height={405}
          className="bg-ui my-8 rounded-md border transition-colors"
          priority
        />
      )}
