export const RadixUISurfaceBg = ({
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="var(--canvas)" />
        <stop offset="0.0833333" stopColor="var(--primary-bordersubtle)" />
        <stop offset="0.364583" stopColor="var(--primary-uiselected)" />
        <stop offset="0.658041" stopColor="var(--canvas)" />
        <stop offset="0.798521" stopColor="var(--primary-uisolid)" />
        <stop offset="0.942708" stopColor="var(--canvas)" />
      ...
      >
        <stop stopColor="var(--canvas)" />
        <stop offset="0.0833333" stopColor="var(--primary-panel)" />
        <stop offset="0.333803" stopColor="var(--primary-canvas)" />
        <stop offset="0.658041" stopColor="var(--canvas)" />
        <stop offset="0.798521" stopColor="var(--primary-uisolid)" />
        <stop offset="0.942708" stopColor="var(--canvas)" />
        <stop offset="1" stopColor="var(--canvas)" />
      ...
      >
        <stop stopColor="var(--canvas)" />
        <stop offset="0.140625" stopColor="var(--primary-ui)" />
        <stop offset="0.333803" stopColor="var(--primary-bordersubtle)" />
        <stop offset="0.658041" stopColor="var(--canvas)" />
        <stop offset="0.798521" stopColor="var(--primary-uisolid)" />
        <stop offset="0.942708" stopColor="var(--canvas)" />
        <stop offset="1" stopColor="var(--canvas)" />
