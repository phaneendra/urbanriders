---
title: Documentation
description: Welcome to the Dev Project documentation.
---

This is the documentation for the Dev Project site.

This is an example of a doc site built using [ContentLayer](/docs/documentation/contentlayer) and MDX.

<Callout>

This site is a work in progress. If you see dummy text on a page, it means I'm still working on it. You can follow updates on Twitter [@phaneendrak](https://twitter.com/phaneendrak).
