---
title: Radio Group
description: A set of interactive radio buttons where only one can be selected at a time.
...
This component inherits props from the [Radio Group primitive](/primitives/docs/components/radio-group) and supports [common margin props](/themes/docs/theme/layout#margin-props).
