---
title: Checkbox
description: Selects a single value, typically for submission in a form.
...
This component inherits props from the [Checkbox primitive](/primitives/docs/components/checkbox) and supports [common margin props](/themes/docs/theme/layout#margin-props).
