...
Contains all the parts of a select. It inherits props from the [Select.Root primitive](/primitives/docs/components/select#root) part.

### Trigger

The button that toggles the select. This component inherits props from the [Select.Trigger primitive](/primitives/docs/components/select#trigger) and [Select.Value primitive](/primitives/docs/components/select#value) parts. It supports [common margin props](/themes/docs/theme/layout#margin-props).
